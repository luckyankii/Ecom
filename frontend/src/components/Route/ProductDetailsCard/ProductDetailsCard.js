...
function ProductDetailsCard({ setOpen, data }) {
  ...
  return (
    <div className="bg-[#fff]">
      {data ? (
        <div
          className={`fixed w-full h-screen top-0 left-0  z-40 flex items-center justify-center`}
        >
          <div className="w-[90%] 800px:w-[60%] h-[90vh] overflow-y-scroll 800px:h-[75vh] bg-white rounded-md shadow-md relative p-4">
            <RxCross1
              size={30}
              className="absolute right-3 top-3 z-50 text-red-700"
            ...
            <div className="block w-full 800px:flex">
              ...
              <div className="w-full 800px:w-[50%]">
                ...
                <div
                  className={`${styles.button} bg-[#000] mt-2 rounded-[4px] h-10`}
                ...
                <h5 className="text-[16px] text-red-700 mt-4">
                  ({data.total_sell}) Sold Out
                </h5>
              </div>
              {/* Right side */}
              <div className="w-full 800px:w-[50%] pt-7 pl-[5px] pr-[5px]">
                ...
                <div className="flex items-center mt-12 justify-between pr-3">
                  <div>
                    ...
                    <span className="bg-gray-300 rounded-t-md text-gray-800 font-medium px-6 py-[15px]">
                      {count}
                    </span>
                    <button
